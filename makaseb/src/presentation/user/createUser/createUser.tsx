...
import { Save, Widgets } from "@material-ui/icons";
    ...
    <div className={classes.row}>
      <div className={classes.textField}>
        <TextField
          ...
          id="emailAdress"
          label="Email Address"
          value={createUserState.user.emailAddress}
          onChange={(event) => {
      ...
      <div className={classes.switch}>
        <IOSSwitch
          onChange={(val, checked) => {
            dispatch(
              editiSEmailNotification({
                isNotification: val.target.value == "true",
              })
            );
          }}
          value={createUserState.user.isEmailNotification}
        ></IOSSwitch>
    ...
    <div className={classes.row}>
      ...
      <div className={classes.switch}>
        <IOSSwitch
          ...
          value={createUserState.user.isSmsNotification}
        ></IOSSwitch>
        <SizedBox width={10}></SizedBox>
