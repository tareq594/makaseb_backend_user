/*Copyright (c), 2011 Sanford, L.P. All Rights Reserved.*/ (function() {
  var n,
    aa = aa || {},
    p = this;
  p.Aa = !0;
  ...
  var se = "AddressObject TextObject BarcodeObject ShapeObject CounterObject ImageObject CircularTextObject DateTimeObject".split(
    " "
  );
  function te(a, b) {
    var d = b || se;
  ...
  function we(a, b, d) {
    ...
    for (
      h = R('<ForeColor Alpha="255" Red="0" Green="0" Blue="0" />')
        .documentElement;
      e.firstChild;
...
*/
  ...
  var P = (function() {
    function a(g, h) {
      if (d)
        throw (O("_createFramework > Error service discovery is in progress. "),
